...
const translations = {
    es: {
        ...
        segmentManagement: "Gestión de habitaciones",
        virtualRestrictionManagement: "Gestión de restricciones virtuales",
        robotCoverageMap: "Mapa de cobertura del robot",
        connectivityOptions: "Opciones de conectividad",
        authSettings: "Ajustes de autenticación",
        mqttConnectivity: "Conectividad MQTT",
        networkAdvertisement: "Anuncio de red",
        ntpConnectivity: "Conectividad NTP",
        robotOptions: "Opciones del robot",
        systemOptions: "Opciones del sistema",
        valetudoOptions: "Opciones de Valetudo",
        systemInformation: "Información del sistema",
        aiAssistant: "Asistente IA",
        generalHelp: "Ayuda general",
        aboutValetudo: "Acerca de Valetudo",
